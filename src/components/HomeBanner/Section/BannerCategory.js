...
export default function BannerCategory() {
  const categories = [
    { title: 'Khung Giờ Săn Sale', logo: '46a2a2c810622f314d78455da5e5d926' },
    {
      ...
      logo: 'b3535d7e56c58c4ebe9a87672d38cc5e',
    },
    {
      title: 'Thứ 4 Freeship - x4 Ưu Đãi',
      logo: 'a8d76bca057ba0b117dcf8e1ef068d16',
    },
    { title: 'Bắt Trend - Giá Sốc', logo: 'b15de7d7368673a82583a88333ed23e7' },
    {
      title: 'Hoàn Xu 6% - Lên Đến 200K',
      logo: '21a4856d1fecd4eda143748661315dba',
    },
    ...
    { title: 'Hàng Quốc Tế', logo: 'a08ab28962514a626195ef0415411585' },
    {
      ...
      logo: '9df57ba80ca225e67c08a8a0d8cc7b85',
    },
...
const CategoryTag = ({ title, logo }) => {
  return (
    <Link href='#'>
      <div
        style={{ backgroundImage: `url('https://cf.shopee.vn/file/${logo}')` }}
      ></div>
      <div>{title}</div>
    </Link>
  );
